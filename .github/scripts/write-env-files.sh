...
if [ -z "$(printenv MATTERMOST_COMMAND_TOKEN || true)" ]; then
  require_env MATTERMOST_REMIND_COMMAND_TOKEN
  require_env MATTERMOST_QUICK_COMMAND_TOKEN
fi
...
BACKEND_DB_PATH=$(optional_env BACKEND_DB_PATH '/data/overview.db')
MATTERMOST_OVERVIEW_WEBHOOK=${MATTERMOST_OVERVIEW_WEBHOOK}
MATTERMOST_COMMAND_TOKEN=$(optional_env MATTERMOST_COMMAND_TOKEN '')
MATTERMOST_REMIND_COMMAND_TOKEN=$(optional_env MATTERMOST_REMIND_COMMAND_TOKEN '')
MATTERMOST_QUICK_COMMAND_TOKEN=$(optional_env MATTERMOST_QUICK_COMMAND_TOKEN '')
INFRA_QUICK_TASK_ENDPOINT=$(optional_env INFRA_QUICK_TASK_ENDPOINT 'http://infra:8080/tasks/quick')
